                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="relative overflow-x-auto shadow-lg sm:rounded-lg ">
                        <div class="px-6 py-4 bg-white dark:bg-gray-900 shadow">
                            <a href="{{ route('createKategori') }}"><button class="cursor-pointer transition-all bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 text-white px-6 py-2 rounded-l border-cyan-600 border-b-[4px] hover:brightness-110  active:border-b-[2px] active:brightness-90 active:translate-y-[2px]">
                            create
                        </button></a>
                        </div>
