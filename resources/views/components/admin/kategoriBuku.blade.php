                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="relative overflow-x-auto shadow-lg sm:rounded-lg ">
                        <div class="px-6 py-4 bg-white dark:bg-gray-900 shadow">
                            <a href="{{ route('createKategori') }}"><button
                            ...
                            <tbody>
                                @foreach ($kategori as $k)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <button data-modal-target="#popup-modal{{ $k->id }}"
                                                data-modal-toggle="popup-modal{{ $k->id }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                Apakah
                                                Anda yakin ingin menghapus Kategori {{ $k->kategori }}?</h3>

                                            <a href="{{ route('deleteKategori', $k->id) }}"> <button
