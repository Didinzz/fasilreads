                            ...
                            <div
                                ...
                                <div class="p-5">
                                    ...
                                    <a href="{{ route('katalogBuku', $c->kategori) }}"
                                        class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat Kategori<svg class="rtl:rotate-180 w-3.5 h-3.5 ms-1" aria-hidden="true"
